...
int main()
{
    ...
    const int total_width{70};  // some consoles are max 70/80 that is why it was chosen
    ...
    for (Country country : tours.countries)
    {
        ...
        {
            std::cout << std::setw(field1_width) << std::left << ((i == 0) ? country.name : "") // conditional operator <-- nice i like it
