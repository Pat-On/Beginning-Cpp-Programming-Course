...
class Mystring
{
    friend Mystring operator-(const Mystring &obj);                      // make lowercase  - unary operator
    friend Mystring operator+(const Mystring &lhs, const Mystring &rhs); // concatenate     - binary operator
