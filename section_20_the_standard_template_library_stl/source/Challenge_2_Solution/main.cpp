...
int main()
{
    ...
    std::list<Song>::iterator current_song = playlist.begin(); // setting iterator
    display_playlist(playlist, *current_song);                 // defensive  programming - to check if this is not pointing out of the list
