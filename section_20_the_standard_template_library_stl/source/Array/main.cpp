...
void test1()
{
    ...
    std::array<int, 5> arr2;                // garbage like always
    ...
    arr1.at(1) = 2000; // do bounce checking - you are going to get exception out of the range
    display(arr1);
...
void test3()
{
    ...
    *ptr = 10000; // first element of the array
...
void test5()
{
    ...
    std::array<int, 5>::iterator min_num = std::min_element(arr1.begin(), arr1.end()); // long way std::array<int, 5>::iterator
    auto max_num = std::max_element(arr1.begin(), arr1.end());                         // short way auto
